"""
Django settings for ComboBroker project.
...
EFRSB_LOGIN = os.getenv('EFRSB_LOGIN')
EFRSB_PASSWORD = os.getenv('EFRSB_PASSWORD')
...
WSGI_APPLICATION = 'ComboBroker.wsgi.application'
